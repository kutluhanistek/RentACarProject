                ...
                <div class="car-wrap rounded ftco-animate">
                    ...
                    <div class="text">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <p class="price ml-auto">{{ optional($car->getPrice)->daily_price ?? 'Fiyat Yok' }} <span>/günlük</span></p>
                        </div>
                        <div class="d-flex mb-3">
                            <p class="price ml-auto">{{ optional($car->getPrice)->weekly_price ?? 'Fiyat Yok' }} <span>/haftalık</span></p>
                        </div>
